...
{\Large \textbf{Simulation-induced finite sample bias in quantities of interest}}\symbolfootnote[1]{All computer code necessary for replication is available on \href{https://github.com/carlislerainey/unnecessary}{GitHub}.}

\vspace{1cm}

Carlisle Rainey\symbolfootnote[2]{Carlisle Rainey is Associate Professor of Political Science, Florida State University, 540 Bellamy, Tallahassee, FL, 32306. (\href{mailto:crainey@tamu.edu}{carlislerainey@gmail.com}).}
...
%\cite{KingTomzWittenberg2000} also offers a simulation-based method for computing such quantities of interest. Using this method, a researcher (1) estimates a model, (2) repeatedly draws model coefficients from their multivariate normal sampling distribution, (3) transforms the coefficients into the desired quantity of interest, and (4) summarizes the sampling distribution of the simulated quantity of interest to obtain point and interval estimates.
...
As discussed above, there are two ways to estimate quantities of interest: the estimate $\hat{\tau}^\text{mle}$ calculated using the ML invariance property and the average simulation estimate $\hat{\tau}^\text{avg}$ calculated using the algorithm described in \cite{KingTomzWittenberg2000}. How does $\hat{\tau}^\text{avg}$ compare to $\hat{\tau}^{\text{mle}}$? %Are they the same? If not, how do they differ? Is one more biased than the other?
...
%Because the ML invariance property offers an straightforward method to compute an estimator with less transformation-induced bias
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.85\linewidth]{intuition-1.pdf}
  \caption{Simulation 1 of 1,000}
  \label{fig:int1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.85\linewidth]{intuition-2.pdf}
  \caption{Simulation 2 of 1,000}
  \label{fig:int2}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.85\linewidth]{intuition-3.pdf}
  \caption{Simulation 3 of 1,000}
  \label{fig:int3}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.85\linewidth]{intuition-4.pdf}
...
\begin{figure}[h]
\begin{center}
\includegraphics[scale = 0.75]{intuition-sampling.pdf}\\
\vspace{.1in}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale = 0.65]{poisson-mcs.pdf}
\vspace{.1in}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[scale = 0.75]{nagler-fd-bias.pdf}\\
\vspace{.1in}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{ge-pr.pdf}
  \caption{}
  \label{fig:ge1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{ge-fd.pdf}
  \caption{}
  \label{fig:ge2}
\end{subfigure}
